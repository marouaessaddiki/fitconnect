...
<a href="create.php">Ajouter une séance</a>
...
<td><?= $seance->getDuree(); ?> min</td>

<td><?= $seance->getActivite(); ?></td>

<td><?= $seance->getEquipement(); ?></td>

<td><?= $seance->getIdAdherent(); ?></td>

<td><?= $seance->getSalleId(); ?></td>

<td>

<a href="edit.php?id=<?= $seance->getIdSeance(); ?>">
Modifier
</a>
...
|
    ...
    <a href="./delete.php?id=<?= $seance->getIdSeance(); ?>">
        Supprimer
    </a>
</td>
</td>
